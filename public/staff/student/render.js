...
export function renderStudentsTable(studentDb, statusMap, departmentMap, tbodyId, toggleOfficerFn, openPaymentFn) {
  ...
  <div class="flex justify-center items-center">
    <label class="switch m-0">
      ...
      <span class="slider round"></span>
                ...
                <td class="px-6 py-4 text-center">
                    <button onclick="${openPaymentFn}('${s.student_id}')" 
...
export function populateDropdown(selectId, items, valueField, textField, selectedValue = null, defaultOption = null) {
    const select = document.getElementById(selectId);
    select.innerHTML = '';
